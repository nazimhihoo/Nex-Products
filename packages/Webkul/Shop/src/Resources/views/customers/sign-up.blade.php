...
>
	...
	<div class="nex-auth-shell container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        <!-- Form Container -->
		<div class="m-auto w-full max-w-[870px] rounded-[30px] border border-zinc-200 bg-white p-16 px-[90px] shadow-[0_24px_70px_rgba(15,23,42,0.08)] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
			<h1 class="text-4xl font-extrabold max-md:text-3xl max-sm:text-xl">
                @lang('shop::app.customers.signup-form.page-title')
            </h1>
