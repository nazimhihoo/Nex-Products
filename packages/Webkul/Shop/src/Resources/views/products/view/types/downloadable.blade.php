@if ($product->type == 'downloadable')
    ...
    <div class="nex-download-info">
        <p class="text-sm font-black text-blue-700">
            Digital Product
        </p>

        <p class="mt-2 text-lg font-semibold text-[#111827]">
            Instant access after payment
        </p>

        <div class="mt-4 grid gap-2 text-sm text-zinc-600">
            <p><strong>Delivery:</strong> Available in your account after successful checkout.</p>
            <p><strong>File type:</strong> Provided by the selected download option.</p>
            <p><strong>File size:</strong> Shown when configured in the downloadable file details.</p>
        </div>
    </div>
