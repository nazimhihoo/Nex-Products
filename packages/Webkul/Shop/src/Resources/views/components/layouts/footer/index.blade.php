...
<footer class="nex-footer mt-9 bg-white max-sm:mt-10">
    <div class="grid gap-8 px-[60px] pt-[54px] max-md:px-8 max-sm:px-4 max-sm:pt-8">
        <div class="grid gap-6 rounded-[30px] bg-[#111827] p-8 text-white lg:grid-cols-[1.2fr_0.8fr]">
            <div>
                <p class="text-3xl font-bold">{{ config('app.name') }}</p>

                <p class="mt-3 max-w-[620px] text-sm leading-6 text-white/75">
                    Premium digital commerce for templates, ebooks, courses, software, tools, AI products, and high-value downloadable resources.
                </p>
            </div>

            <div class="grid gap-2 text-sm">
                <p class="font-bold text-cyan-200">Real Support</p>

                <a
                    href="mailto:mr.nazimx@gmail.com"
                ...
                <a
                    href="https://wa.me/923463206754"
                    class="text-white/85 hover:text-white"
                    target="_blank"
                    rel="noopener"
                >
                    WhatsApp Support: +923463206754
                </a>
            </div>
        </div>
    </div>

    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] pt-8 max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        <!-- For Desktop View -->
        <div
    ...
    <div class="flex justify-between border-t border-slate-200 bg-slate-50 px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
