...
<div class="nex-mobile-header flex flex-wrap gap-4 bg-white px-4 pt-5 pb-4 text-[#111827] shadow-sm lg:hidden">
    <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-x-1.5">
            ...
            >
                @if (core()->getCurrentChannel()->logo_url)
                    ...
                    >
                @else
                    <span class="text-lg font-black tracking-tight text-[#111827]">
                        Nex Products
                    </span>
                @endif
            </a>
        ...
        <!-- Right Navigation -->
        <div>
            <div class="flex items-center gap-x-5 max-md:gap-x-4 [&_span]:text-[#111827]">
    ...
    <!-- Serach Catalog Form -->
    <form action="{{ route('shop.search.index') }}" class="nex-global-search flex w-full items-center overflow-hidden rounded-full border border-slate-200 bg-white focus-within:border-blue-400">
        <label
            for="organic-search"
            class="sr-only"
        >
        ...
        <div class="relative flex w-full">
            <input
                type="text"
                class="block w-full border-0 px-4 py-3.5 text-sm font-semibold text-gray-900 outline-none max-md:py-3 max-sm:text-xs"
                name="query"
                value="{{ request('query') }}"
            ...
            <button
                type="submit"
                class="flex min-w-[52px] items-center justify-center bg-[#111827] text-white"
                aria-label="@lang('shop::app.components.layouts.header.mobile.submit')"
            >
