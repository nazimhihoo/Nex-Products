...
<div class="nex-desktop-header flex min-h-[82px] w-full justify-between px-[42px] text-[#111827] shadow-[0_10px_30px_rgba(15,23,42,0.06)] max-1180:px-5">
    <!--
        This section will provide categories for the first, second, and third levels. If
        additional levels are required, users can customize them according to their needs.
    -->
    <!-- Left Nagivation Section -->
    <div class="flex items-center gap-x-7 max-[1180px]:gap-x-4">
        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottom.logo.before') !!}

        <a
            href="{{ route('shop.home.index') }}"
            class="nex-brand-mark flex items-center rounded-2xl border border-transparent px-2 py-1 transition hover:border-blue-200"
        ...
        >
            @if (core()->getCurrentChannel()->logo_url)
                ...
                >
            @else
                <span class="text-xl font-black tracking-tight text-[#111827]">
                    Nex Products
                </span>
            @endif
        </a>
    ...
    <div class="flex flex-1 items-center justify-end gap-x-5 max-[1100px]:gap-x-4 max-lg:gap-x-8">
        ...
        <div class="relative w-full max-w-[680px]">
            <form
                ...
                class="nex-global-search flex items-center overflow-hidden rounded-full border border-slate-200 bg-white transition focus-within:border-blue-400"
                role="search"
            >
                <select
                    name="category"
                    class="min-h-[48px] max-w-[150px] border-0 bg-slate-50 px-4 text-xs font-bold text-slate-700 outline-none"
                ...
                <input
                    ...
                    name="query"
                    value="{{ request('query') }}"
                    class="block min-h-[48px] w-full border-0 px-4 py-3 text-sm font-semibold text-gray-900 outline-none"
                ...
                <button
                    type="submit"
                    class="flex min-h-[48px] min-w-[58px] items-center justify-center bg-[#111827] text-white transition hover:bg-blue-600"
        ...
        <div class="nex-header-actions mt-1.5 flex items-center gap-x-5 max-[1100px]:gap-x-4 max-lg:gap-x-8 [&_span]:text-[#111827]">
            ...
            <x-shop::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
                <x-slot:toggle>
                    <span
                        class="inline-block cursor-pointer rounded-full border border-slate-200 bg-white p-2 text-2xl icon-users transition hover:border-blue-300 hover:text-blue-600"
                        role="button"
...
@pushOnce('scripts')
    ...
    >
        ...
        >
            <div
                class="group relative flex h-[74px] items-center border-b-4 border-transparent hover:border-b-4 hover:border-blue-500"
                v-for="category in categories"
            >
                <span>
                    <a
                        :href="category.url"
                        class="inline-block px-4 text-sm font-bold text-slate-700 hover:text-blue-600"
                    >
                        @{{ category.name }}
                    </a>
                </span>
                ...
                <div
                    class="pointer-events-none absolute top-[74px] z-[1] max-h-[580px] w-max max-w-[1260px] translate-y-1 overflow-auto overflow-x-auto rounded-b-2xl border border-b-0 border-l-0 border-r-0 border-t border-[#F3F3F3] bg-white p-9 opacity-0 shadow-[0_18px_45px_rgba(0,0,0,.18)] transition duration-300 ease-out group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-hover:duration-200 group-hover:ease-in ltr:-left-9 rtl:-right-9"
        ...
        <div v-else>
            ...
            <div class="flex items-center">
                ...
                <div
                    class="flex h-[74px] cursor-pointer items-center border-b-4 border-transparent hover:border-b-4 hover:border-blue-500"
                    @click="toggleCategoryDrawer"
                >
                    <span class="flex items-center gap-1 px-4 text-sm font-bold text-slate-700">
