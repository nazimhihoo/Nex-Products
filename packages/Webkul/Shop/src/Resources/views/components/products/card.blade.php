...
@pushOnce('scripts')
    ...
    >
        <!-- Grid Card -->
        <div
            class="nex-product-card 1180:transtion-all group w-full rounded-md 1180:relative 1180:grid 1180:content-start 1180:overflow-hidden 1180:duration-300"
            v-if="mode != 'list'"
        >
            <div class="nex-product-media relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                ...
                >
                    <x-shop::media.images.lazy
                        class="after:content-[' '] relative bg-transparent transition-all duration-300 after:block after:pb-[calc(100%+9px)] group-hover:scale-105"
                ...
                <div class="action-items bg-black">
                    <p
                        class="nex-digital-badge"
                        v-if="product.type == 'downloadable' || product.type == 'virtual'"
                    >
                        Digital
                    </p>
            ...
            <div class="nex-product-info -mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">
                ...
                <div class="action-items flex items-center justify-between opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 max-md:hidden">
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        ...
                        <button
                            class="secondary-button w-full max-w-full p-2.5 text-sm font-bold max-sm:rounded-xl max-sm:p-2"
