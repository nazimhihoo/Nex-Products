...
@pushOnce('scripts')
    ...
    >
        <div
            class="nex-products-carousel container mt-20 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4"
            v-if="! isLoading && products.length"
        >
            <div class="flex justify-between">
                <h2 class="text-3xl font-extrabold max-md:text-2xl max-sm:text-xl" v-if="title">
                    @{{ title }}
                </h2>
