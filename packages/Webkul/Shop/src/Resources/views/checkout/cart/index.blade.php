...
>
    ...
    <div class="flex flex-wrap">
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 bg-white px-[60px] py-4 shadow-[0_10px_30px_rgba(15,23,42,0.06)] max-lg:px-8 max-md:px-4">
    ...
    <div class="flex-auto">
            <div class="nex-page-shell container px-[60px] max-lg:px-8 max-md:px-4">
            ...
            app.component("v-cart", {
                ...
                methods: {
                    ...
                    moveToWishlistSelectedItems() {
                        const moveToWishlistUrl = @json(\Illuminate\Support\Facades\Route::has('shop.api.checkout.cart.move_to_wishlist') ? route('shop.api.checkout.cart.move_to_wishlist') : null);

                        if (! moveToWishlistUrl) {
                            return;
                        }
                        ...
                        this.$emitter.emit('open-confirm-modal', {
                            agree: () => {
                                ...
                                this.$axios.post(moveToWishlistUrl, {
                                        'ids': selectedItemsIds,
