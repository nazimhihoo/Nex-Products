...
>
    ...
    <!-- Page Header -->
    <div class="flex-wrap">
        <div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 bg-white px-[60px] py-4 shadow-[0_10px_30px_rgba(15,23,42,0.06)] max-lg:px-8 max-sm:px-4">
    ...
    <!-- Page Content -->
    <div class="nex-page-shell container px-[60px] max-lg:px-8 max-sm:px-4">
                    ...
                    <div class="sticky top-8 block h-max w-[442px] max-w-full max-lg:w-auto max-lg:max-w-[442px] ltr:pl-8 max-lg:ltr:pl-0 rtl:pr-8 max-lg:rtl:pr-0">
                        ...
                        >
                            ...
                            <template v-else>
                                <x-shop::button
                                    type="button"
                                    class="primary-button w-max rounded-2xl px-11 py-3 max-md:mb-4 max-md:w-full max-md:max-w-full max-md:rounded-lg max-sm:py-2"
