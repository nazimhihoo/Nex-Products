    ...
    <div class="flex items-center gap-1 sm:gap-1.5">
        ...
        <a href="{{ route('admin.dashboard.index') }}" class="flex-shrink-0">
            ...
            @else
                <span
                    id="logo-image"
                    class="inline-flex h-10 items-center rounded-xl bg-gray-950 px-3 text-sm font-black tracking-tight text-white shadow-sm dark:bg-white dark:text-gray-950"
                >
                    {{ config('app.name', 'NexProducts') }}
                </span>
            @endif
        </a>
        ...
        <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            ...
            <x-slot:content class="!p-0">
                <div class="flex items-center gap-1.5 border border-b-gray-300 px-4 py-2 dark:border-gray-800 sm:px-5 sm:py-2.5">
                    <span class="flex h-6 w-6 items-center justify-center rounded-lg bg-gray-950 text-xs font-black text-white dark:bg-white dark:text-gray-950">
                        N
                    </span>
