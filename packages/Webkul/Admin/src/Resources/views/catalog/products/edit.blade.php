        ...
        <div class="grid gap-2.5">
            <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                <div class="grid gap-1.5">
                    ...
                    <div class="nex-admin-note text-sm">
                        <strong>Digital product control:</strong>
                        this product is currently
                        <strong>{{ ucfirst($product->type) }}</strong>.
                        Use Bagisto's product type and downloadable link fields to enable or disable instant download access without changing the product system.
                    </div>
                </div>
